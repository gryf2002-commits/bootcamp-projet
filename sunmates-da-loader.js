  ...
  function applyTokens(T) {
    ...
    Object.keys(T.modes).forEach(function (k) {
      ...
      if (m.page || m.ink) {
        ...
        css += '--text:' + text + ';';
        css += '--muted:' + muted + ';';
        css += '--line:' + _mix(pg, ink, 0.10) + ';'; /* v754 : NEUTRE très discret (champs/boutons only) — les filets de séparation de CONTENU sont retirés en CSS, la structure = espace + en-têtes. */
