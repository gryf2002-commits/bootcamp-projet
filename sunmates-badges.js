...
(function () {
  ...
  var EM = {
    ...
    reviewer:'<circle cx="32" cy="31" r="25" fill="url(#emb-atmo)"/><ellipse cx="32" cy="52" rx="16" ry="3.4" fill="url(#emb-shadow)"/><path d="M13 13h38a7 7 0 0 1 7 7v15a7 7 0 0 1-7 7H30l-9 8v-8h-8a7 7 0 0 1-7-7V20a7 7 0 0 1 7-7z" fill="url(#emb-coral)" stroke="#fff" stroke-width="1"/><path d="M32 17.5l3.4 7 7.6.6-5.8 5 1.7 7.4L32 40.6l-6.9 3.9 1.7-7.4-5.8-5 7.6-.6z" fill="url(#emb-gold)" stroke="#A9670F" stroke-width=".6"/><ellipse cx="20" cy="20" rx="6" ry="4" fill="url(#emb-spec)"/>',
