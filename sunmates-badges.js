...
(function () {
  ...
  var EM = {
    ...
    foodie:'<circle cx="32" cy="34" r="25" fill="url(#sm2-halo-warm)"/><ellipse cx="32" cy="52" rx="20" ry="4" fill="url(#sm2-shadow)"/><g fill="none" stroke="url(#sm2-coral)" stroke-width="1.8" stroke-linecap="round" opacity=".85"><path d="M26 15c-1.6 2 1.6 3.2 0 5.2"/><path d="M38 15c-1.6 2 1.6 3.2 0 5.2"/></g><path d="M14 28h36v2.2H14z" fill="url(#sm2-gold)"/><path d="M16 29a16 13 0 0 1 32 0z" fill="url(#sm2-gold-cab)" stroke="#9A5E14" stroke-width="1"/><path d="M48 29a16 13 0 0 0-10-12 16 13 0 0 1 10 12z" fill="#9A5E14" opacity=".22"/><circle cx="32" cy="13.6" r="2.6" fill="url(#sm2-coral)" stroke="#fff" stroke-width=".7"/><ellipse cx="32" cy="46" rx="22" ry="6" fill="url(#sm2-amber)" stroke="#9A5E14" stroke-width="1"/><ellipse cx="32" cy="45" rx="22" ry="5" fill="none" stroke="#9A5E14" stroke-width=".7" opacity=".4"/><path d="M8 28v14M12 28v14M8 38h4M52 28c4 0 4 6 0 8v6" stroke="url(#sm2-gold)" stroke-width="2.2" fill="none" stroke-linecap="round"/><path d="M20 24a16 12 0 0 1 17-4" fill="none" stroke="#FFF2C2" stroke-width="1.3" opacity=".65"/><ellipse cx="24" cy="25" rx="6" ry="3.5" fill="url(#sm2-spec)"/>',
